...
# pyrender没办法渲染normal。
################################################################ Hyperparameters ################################################################
mesh_dir = '/runs/runs_tnt3-5/tnt3_1/2024-05-12_20-05-24/plots/mesh_2667.ply'
data_dir = '/data/monosdf/tnt_neuRIS/scene1'
out_dir = 'tntscan1'
gt_space = False # 输入的mesh是否已经是gt space
textured = False
