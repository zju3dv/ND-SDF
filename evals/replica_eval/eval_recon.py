...
def calc_3d_metric(rec_meshfile, gt_meshfile, align=False):
    ...
    print('Acc Comp Chamfer Prec Recal F-score Normal Acc Normal Comp Normal Avg')
    print(accuracy_rec, completion_rec, chamfer_dist, precision_ratio_rec, completion_ratio_rec, fscore, normal_acc, normal_comp,
          normal_avg)
