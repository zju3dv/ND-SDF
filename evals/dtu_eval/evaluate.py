...
Offical_DTU_Dataset = "/data/mydata/DTU"
...
root_dir = '../runs/'
exp_names = ["dtu_grids_3viewsexp1"]

# 批量cull_mesh+eval<conf.expname>_<scan>train出的latest mesh
# cull mesh save to out_dir, out_dir is: evaluation/<scan>/<expname>_<mesh_name>
