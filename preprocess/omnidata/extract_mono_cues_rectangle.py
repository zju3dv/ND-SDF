...
def get_args():
    ...
    args.add_argument('--input_dir', type=str, default='/data/scannet/scans/scene0616_00/rgb',
                      help="输入图像分辨率宽高比不一致为长方形时...")
...
def main(args):
    ...
    pretrained_weights_path = os.path.join('./pretrained_models',
                                           f"omnidata_dpt_{args.task}_v2.ckpt")  # 'omnidata_dpt_depth_v1.ckpt'
